...
('ACCEPTED', 1, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 DAY', 50.0, 1),
('ACCEPTED', 2, CURRENT_DATE, CURRENT_DATE + INTERVAL '2 DAY', 160.0, 2),
('ACCEPTED', 3, CURRENT_DATE, CURRENT_DATE + INTERVAL '3 DAY', 300.0, 3),
('ACCEPTED', 4, CURRENT_DATE, CURRENT_DATE + INTERVAL '4 DAY', 480.0, 4),
('ACCEPTED', 5, CURRENT_DATE + INTERVAL '2 DAY', CURRENT_DATE + INTERVAL '4 DAY', 200.0, 1),
('ACCEPTED', 6, CURRENT_DATE + INTERVAL '3 DAY', CURRENT_DATE + INTERVAL '7 DAY', 520.0, 2),
('ACCEPTED', 6, CURRENT_DATE - INTERVAL '2 DAY', CURRENT_DATE - INTERVAL '1 DAY', 520.0, 2);